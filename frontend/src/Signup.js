    ...
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh', padding: '20px' }}>
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          ...
          <h2 style={{ fontSize: '32px', fontWeight: 700, margin: 0 }}>Start Your Journey</h2>
          <p style={{ color: 'var(--text-muted)', marginTop: '8px' }}>Join the medical tracker community.</p>
        </div>

        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: '20px' }}>
            <label style={{ display: 'block', fontSize: '14px', fontWeight: 600, marginBottom: '8px', color: 'var(--text-active)' }}>Full Name</label>
            <input
              type="text"
              value={name}
